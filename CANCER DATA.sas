...
SITE = '1-FAUCIAL ARCH 2-TONSILLAR FOSSA 3-POSTERIOR PILLAR 4-PHARYNGEAL TOUNGE 5-POSTERIOR WALL'
T_STAGE = '1-PRIMARY TUMOR 2CM OR LESS 2-PRIMARY TUMOR 2CM TO 4CM WITH MINIMAL INFILTRATION IN DEPTH 3-PRIMARY TUMOR 4+CM 4-MASSIVE INVASIVE TUMOR'  
N_STAGE = '0-NO CLINICAL EVIDENCE OF NODE METASTASES 1-SINGLE POSITIVE NODE 3CM OR LESS NOT FIXED 2-SINGLE POSITIVE NODE 3+CM IN DIAMETER NOT FIXED 3-MULTIPLE POSITIVE NODES OR FIXED POSITIVE NODES'
ENTRY_DT = 'DATE OF STUDY ENTRY DDDYY'
STATUS = '0-CENSORED 1-DEAD'
TIME = 'SURVIVAL TIME IN DAYS FROM DIAGNOSIS';
DATALINES;
...
141   1   2   2   3   90  9   2   3   0   10571    1    446
